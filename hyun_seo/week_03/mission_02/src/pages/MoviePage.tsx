...
export default function MoviePage() {
  ...
  // 마운트될 때 한 번만 실행시켜주고 싶어서 useEffect
  useEffect(() => {
...
return (
  <>
    <div className='flex items-center justify-center gap-6 mt-5'>
      ...
      hover:bg-[#b2dab1] trnasition-all duration-200 disabled:bg-gray-300
      ...
      <button className='bg-[#dda5e3] text-white px-6 py-3 rounded-lg shadow-md 
      hover:bg-[#b2dab1] trnasition-all duration-200 cursor-pointer' 
