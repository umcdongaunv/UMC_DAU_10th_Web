...
.refine((data) => data.password === data.passwordCheck, {
  ...
  path: ["passwordCheck"], // 🔥 중요: 여기 때문에 passwordCheck 아래에 뜸
});
        ...
        {step === 3 && (
          <>
            ...
            className={`py-3 rounded text-white transition
               ${isStep3Valid ? "bg-pink-500 hover:bg-pink-600" : "bg-gray-500 cursor-not-allowed"}
            `}
            >
            회원가입 완료
            </button>
